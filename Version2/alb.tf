...
resource "aws_lb_target_group" "GRP2-tg" {
  name     = "GRP2-tg"
  port     = 31000 # Choisissez un port dans la plage 30000-32767
  protocol = "HTTP"
